...
def load_pywal_colors():
    ...
    special = colorsjs['special']
    colors = colorsjs['colors']
    c.colors.tabs.bar.bg = colors['color1']
    ...
    c.colors.tabs.odd.fg = giveColorBasedOnLuminance(colors['color8'],special['foreground'],special['background'])
  
    c.colors.tabs.selected.even.bg = colors['color4']
    c.colors.tabs.selected.even.fg = giveColorBasedOnLuminance(colors['color4'],special['foreground'],special['background'])
    c.colors.tabs.selected.odd.bg = colors['color4']
    c.colors.tabs.selected.odd.fg = giveColorBasedOnLuminance(colors['color4'],special['foreground'],special['background'])
